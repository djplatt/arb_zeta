...
Note:- Here we are just checking RH so once we have isolated a zero, we move on
       "Isolating..." desribes a computation where we then resolved the zero to
           some precision (102 bits absolute in fact).
*/
